...
- **M** = 1-2 天
- **L** = 3 天
- 超過 L 就要把討論任務或分配，將任務拆成更細或是有人能協助分工

---

### 異步 Daily Check-in

每天團隊的確認時間點在 團隊溝通工具 中寫三句重點：
...
例：本期總共 8 個 Task （8張卡片） = 3S + 4M + 1L → 預算 3×1 + 4×2 + 1×4 = **15 點**

> 第一個 sprint 憑直覺挑「應該做得完」的量；做完之後，下個 sprint 就有「我們組真實的負荷」作參考，以此不斷迭代優化。
...
**判讀**：
- 完成率 **≥ 80%** → 健康，下個 sprint 可以稍微增加一點Task/產量
- 完成率 **60-80%** → 還行，下 sprint 維持Task/產量
- 完成率 **< 60%** → 嚴重，下 sprint ，評估是否估算太過樂觀，減少Task/產量
...
#### 推薦 1：Discord + Notion/Trello + GitHub
...
### [參考] Channel 設計（Discord / Slack 共用）
...
← [回到 README](README.md) | 下一步：[01 GitHub 註冊、開通與 Fork SOP →](01-github-setup-sop.md)
