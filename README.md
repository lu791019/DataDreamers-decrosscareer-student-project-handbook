...
| 等級 | 樣貌 | 在面試時的反應 |
|---|---|---|
| 學作業 | 跑得起 notebook、沒架構圖、commit 訊息大多「update」、README 一句話、demo 是手動 run 一次 | 面試官比較難看到亮點 |
| 學作品 | 有 README、能跑、技術棧豐富 | 「不錯，但跟別人差不多」 |
| 業界 demo | 有架構圖、有 PR 紀錄、有 retro、有監控、能講為什麼選 A 不選 B | 「我們聊聊你這個專案」 |

**這份手冊想幫你做到的**：照著走一遍，你的專案會比較容易停在第三層，讓面試官想多問幾句。
