...
> 流程跑得順、訊息傳得清楚、卡關有人接 —— 這三件事決定 8 週能不能活著走完。
...
學員專案 8 週、4 個人、需求會變、不會做完美 —— 這正是敏捷被設計來解決的場景。
...
**前置**：[02 階段流程](02-team-process.md) 寫好的 PLAN.md。
...
retro 在 [05](05-retro-and-after.md) 已詳述。補充給卡住的人：
