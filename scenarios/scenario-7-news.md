...
| 週 | 階段 | 重點產出 |
|---|---|---|
| W0 | 啟動 | 監控目標品牌選定 + LLM budget |
| W1 | Discovery | 警示策略 + 分類體系 |
| W2 | 設計 + 分工 | 2-stage classifier 設計 |
| W3 | Sprint 1 | 100 篇通 + 分類 + 入庫 |
| W4-5 | Sprint 2 | 多 source + 自動化 + cluster |
| W6 | Sprint 3 | LINE 推播 + 趨勢 + cost monitor |
| W7 | 整合 + 上線 | end-to-end |
| W7-8 | Demo + 復盤 | live demo + 商業價值 |
